...
def parse_args():
    ...
    parser.add_argument('--isLocal', type=str2bool, default=False, help='Is the non-critical param defined by local model.')
    ...
    parser.add_argument('--isHessian', type=str2bool, default=False, help='Is the non-critical param defined by hessian.')
...
exp_args = dict(
    ...
    other=dict(test_freq=1, logging_path=f'./logging/cifar10_purin_resnet/{args.noniid}_{args.alpha}_{args.tau}_{args.exc}_{args.seed}_{args.HeadEnd}_{args.isLocal}_{args.isHessian}_{args.isGrad}_{args.client_num}')
   # other=dict(test_freq=1, logging_path=f'./logging/cifar10_purin_resnet_savemask/{args.noniid}_{args.alpha}_{args.tau}_{args.exc}_{args.seed}_{args.HeadEnd}_{args.isLocal}_{args.isHessian}_{args.isGrad}_{args.client_num}')
)
