...
def parse_args():
    ...
    parser.add_argument('--beta', type=int, default=170, help='default: 100')
...
exp_args = dict(
    ...
    other=dict(test_freq=1, logging_path=f'./logging/cifar100_fedcac_resnet/{args.noniid}_{args.alpha}_{args.client_num}/{args.tau}_{args.beta}/{args.seed}')
)
