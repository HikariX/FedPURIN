...
exp_args = dict(
    ...
    learn=dict(
        ...
        global_eps=200,
        batch_size=100,
        optimizer=dict(name='sgd', lr=0.1, momentum=0.9), test_place=['after_aggregation', 'before_aggregation'],
    ...
    client=dict(name='fedrod_client', client_num=20),
    ...
    other=dict(test_freq=1, logging_path=f'./logging/cifar10_fedrod_resnet/{args.noniid}_{args.alpha}_{args.seed}')
)
