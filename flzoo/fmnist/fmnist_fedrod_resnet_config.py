...
exp_args = dict(
    ...
    model=dict(name='resnet8', input_channel=1, class_number=10, fedrod_head=True),
    ...
    other=dict(test_freq=1, logging_path=f'./logging/fmnist_fedrod_resnet/{args.noniid}_{args.alpha}_{args.seed}')
)
