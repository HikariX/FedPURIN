...
def parse_args():
    ...
    parser.add_argument('--beta', type=int, default=170, help='default: 170')
...
exp_args = dict(
    ...
    other=dict(test_freq=1, logging_path=f'./logging/cifar100_purin_resnet/{args.noniid}_{args.alpha}_{args.tau}_{args.exc}_{args.seed}_{args.HeadEnd}_{args.isLocal}_{args.isHessian}_{args.isGrad}_{args.client_num}')
)
